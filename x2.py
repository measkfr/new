...
print("\n" + "="*70)
print("🤖 TELEGRAM BROWSER 2 (DIGIT: 9)")
print("="*70)

# Setup Chrome
options = Options()
options.add_argument("--start-maximized")
options.add_argument("--user-data-dir=C:\\Users\\rosha\\telegram_bot_2")
...
print("📱 Please login with QR code in Browser 2")
...
if not msg_box:
    try:
        ...
        if msg_box.is_displayed():
            print("✅ Found message box by ID: editable-message-text")
    except:
        pass
...
# Start messaging
print("\n🎯 READY! Sending numbers starting with 9")
